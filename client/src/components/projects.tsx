...
const projects = [
  ...
  },
  {
    ...
    description: "Live cricket scoring with WebSocket-driven real-time updates and full Razorpay payment integration (order creation, modal, webhook verification). Redis caching + MongoDB indexing optimized for 1,000+ concurrent users.",
    image: "https://images.unsplash.com/photo-1540747913346-19e32dc3e97e?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=300",
    tags: ["React.js", "Node.js", "TypeScript", "WebSockets", "Redis", "Razorpay"],
    liveUrl: "#",
  ...
  },
  {
    ...
    description: "Production-ready SaaS starter with Auth.js v5 (magic links + Google OAuth) and full Stripe subscription billing — Checkout, Customer Portal, and webhooks. Admin dashboard tracks active subscribers and estimated MRR.",
    image: "https://images.unsplash.com/photo-1563986768609-322da13575f3?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=300",
    tags: ["Next.js 16", "TypeScript", "Auth.js v5", "Stripe", "Prisma"],
    liveUrl: "#",
  ...
  },
  {
    ...
    description: "React Native (Expo) payment dashboard backed by NestJS + PostgreSQL. Supports transaction filtering, RBAC admin management, real-time WebSocket updates, CSV export, and push notifications.",
    image: "https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=300",
    tags: ["React Native", "NestJS", "PostgreSQL / TypeORM", "TypeScript", "WebSockets"],
    liveUrl: "#",
  ...
  },
  {
    ...
    description: "Autonomous agent that searches job listings, tailors applications to each posting, and manages the end-to-end job hunt workflow using LLM APIs and agentic frameworks.",
  ...
  },
  {
    ...
    description: "Environmental monitoring system processing satellite and sensor data on Google Cloud, with anomaly detection algorithms for deforestation pattern identification using Vertex AI and BigQuery.",
  ...
  },
  {
    ...
    description: "Five-module student productivity app — notes with PDF viewer, attendance tracker, habits & todo, budget manager, and dark-themed settings — built on MVVM with a 5-entity Room database and KSP code generation.",
    image: "https://images.unsplash.com/photo-1517694712202-14dd9538aa97?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=300",
    tags: ["Kotlin", "Jetpack Compose", "Material 3", "Room DB", "DataStore"],
    liveUrl: "#",
    githubUrl: "https://github.com/darshhannnn",
    featured: false,
    badge: "Android",
  ...
  },
  {
    ...
    description: "Interactive lender dashboard for credit risk assessment built with a Gradient Boosting classifier and synthetic data generation. Built for the Poonawalla Fincorp Hackathon.",
    image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=300",
    tags: ["Python", "FastAPI", "Gradient Boosting", "Data Science"],
    liveUrl: "#",
    githubUrl: "https://github.com/darshhannnn",
    featured: false,
    badge: "FinTech / ML",
