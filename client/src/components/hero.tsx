...
export default function Hero() {
  ...
  useEffect(() => {
    // Small timeout so the initial paint happens at opacity:0, then fades in
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      >
        {/* Status badge */}
        <div
          className="inline-flex items-center gap-3 px-5 py-2.5 rounded-full glass-strong mb-8"
          style={fadeIn(mounted, 0.1)}
        >
        ...
        {/* Description */}
        <p
          className="text-lg sm:text-xl text-white/40 max-w-3xl mx-auto mb-12 leading-relaxed"
          style={fadeIn(mounted, 0.5)}
        >
        ...
        {/* Social */}
        <div className="flex justify-center gap-3" style={fadeIn(mounted, 0.8)}>
          {[
